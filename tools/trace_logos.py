"""
Vectorise the Lane Change wordmark and LC monogram from the approved mockup
...
# LC monogram from the embroidered close-up
trace(SRC[640:722, 225:300], 8, 80, "monogram", blur=3, turd=400, open_k=7, close_k=9)
